...
@section('content')
  <div class="contenedor">
    <div class="cuerpo">
<h1 class="parrafochallenge">Reglas del Juego</h1>
     <div class="columnastexto">
       <h2>Objetivo del Juego</h2>
       <p class="parrafochallenge">El Juego se termina cuando se hayan respondido todas las preguntas
       o en el momento que el jugador se canse y deje de jugar. Cada jugador tiene la posibilidad de agregar preguntas que al azar puede jugar con ellas o no.</p>
     </div>
     <div class="columnastexto">
       <h2>Cómo se juega</h2>
     ...
     <div class="columnastexto">
       ...
       <p class="parrafochallenge">El jugador puede finalizar el juego en el momento que desee. Las preguntas tienen un timer que da 10 segundos, en el caso que no se conteste en ese tiempo la pregunta se considera incorrecta. </p>
     </div>
     <div class="columnastexto">
       <h2>Puntaje</h2>
